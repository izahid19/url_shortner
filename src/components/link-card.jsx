    ...
    <div className="flex flex-col md:flex-row gap-5 border p-4 bg-gray-900 rounded-lg shadow-lg">
      ...
      <Link to={`/link/${url?.id}`} className="flex flex-col flex-1">
        ...
        <span className="text-lg md:text-2xl font-bold mb-3 break-words">
          ...
          <span className="text-blue-400 hover:underline cursor-pointer">
            https://trimmm.netlify.app/.netlify/functions/redirect/{url?.custom_url || url.short_url}
          </span>
        </span>
      ...
      <div className="flex gap-2 mt-4 md:mt-0 justify-center md:justify-start">
        <Button
          variant="ghost"
          onClick={() =>
            navigator.clipboard.writeText(`https://trimmm.netlify.app/.netlify/functions/redirect/${url?.custom_url || url.short_url}`)
          }
